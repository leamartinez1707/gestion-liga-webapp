...
insert into series (id, name, slug, description) values
  ('s0000000-0000-0000-0000-000000000001', 'Serie 1', 'serie-1', 'Competencia principal de la liga'),
  ('s0000000-0000-0000-0000-000000000002', 'Serie 2', 'serie-2', 'Segunda línea de competencia');

-- -----------------------------------------------------------------------------
-- Divisions
-- -----------------------------------------------------------------------------
insert into divisions (id, series_id, name, display_order) values
  ('d1000000-0000-0000-0000-000000000001', 's0000000-0000-0000-0000-000000000001', 'División A', 1),
  ('d1000000-0000-0000-0000-000000000002', 's0000000-0000-0000-0000-000000000001', 'División B', 2),
  ('d1000000-0000-0000-0000-000000000003', 's0000000-0000-0000-0000-000000000001', 'División C', 3),
  ('d1000000-0000-0000-0000-000000000004', 's0000000-0000-0000-0000-000000000002', 'División A', 1),
  ('d1000000-0000-0000-0000-000000000005', 's0000000-0000-0000-0000-000000000002', 'División B', 2);

-- -----------------------------------------------------------------------------
-- Tournaments
-- -----------------------------------------------------------------------------
insert into tournaments (id, name, category, series_id, division_id, season, format, start_date, end_date) values
  ('a0000000-0000-0000-0000-000000000001', 'Temporada 2026', 'Primera División', 's0000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', '2026', 'league', '2026-04-01', '2026-11-30'),
  ('a0000000-0000-0000-0000-000000000002', 'Temporada 2026', 'Segunda División', 's0000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000002', '2026', 'league', '2026-04-01', '2026-11-30');

-- -----------------------------------------------------------------------------
-- Teams
-- -----------------------------------------------------------------------------
insert into teams (id, name, short_name, category, series_id, division_id, coach, assistant_coach, tournament_id) values
  ('b0000000-0000-0000-0000-000000000001', 'Club Atlético Los Pumas', 'Los Pumas', 'Primera División', 's0000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Carlos Rodríguez', 'Martín Gómez', 'a0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000002', 'Titanes Futsal Club', 'Titanes', 'Primera División', 's0000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Diego Fernández', null, 'a0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000003', 'Deportivo Estrella Roja', 'Estrella Roja', 'Primera División', 's0000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Pablo Martínez', 'Lucas Silva', 'a0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000004', 'Sportivo Huracán', 'Huracán', 'Primera División', 's0000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Alejandro Torres', 'Gabriel Ríos', 'a0000000-0000-0000-0000-000000000001');
